      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <a
            ...
            className="bg-cta-green hover:bg-cta-hover text-white px-6 py-2 rounded-full flex items-center gap-2 transition-colors duration-300 shadow-md hover:shadow-lg font-sans"
          >
